...
humandate: "April 26-27, 2023"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "1:00pm - 4:30 pm"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
startdate: 2023-04-26      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2023-04-27        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
scw_project: "scw1389"  # project code for the SCW training project for this event
instructor: ["Ed Bennett", "Julian Lenz"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Tianyi Pan", "Julian Lenz"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: "https://pad.carpentries.org/2023-04-26-swansea"            # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
...
<p id="registration"><strong>Registration:</strong> <a href="https://tocyn.cymru/en/event/9ae55ee0-bf6f-45bf-ba38-56dd20159abe">Tocyn Cymru</a></p>
